...
ms.locfileid: "3298229"
---
# <a name="monitor-activity-in-power-automate-from-your-phone"></a>Supervisar la actividad en Power Automate desde el teléfono
...
1. Si el flujo no se ha ejecutado antes, desencadene una ejecución para generar datos.
    ...
    Los campos pueden tardar algún tiempo en aparecer en la aplicación.
...
5. Para filtrar el resumen de la actividad, pulse el icono en la esquina superior derecha.
    ...
    Puede mostrar todas las entradas, solo entradas con error o solo las entradas que incluyen notificaciones de inserción.
...
## <a name="show-details-of-a-run"></a>Representación de los detalles de una ejecución
...
2. En la parte inferior de la pantalla, pulse **See previous runs** (Ver ejecuciones anteriores) para enumerar todas las ejecuciones del flujo y, luego, pulse una ejecución para mostrar sus detalles.
    ...
    ![Historial de ejecuciones correctas y con errores](./media/mobile-monitor-activity/history-mixed.png)
