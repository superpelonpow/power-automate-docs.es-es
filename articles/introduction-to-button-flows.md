...
6. Seleccione el botón **Aceptar** si está de acuerdo con autorizar a Power Automate a acceder a su cuenta de VSO.  
...
7. Ya está preparado para configurar las propiedades de la compilación que desea iniciar:    
   ![Pantalla Properties](./media/introduction-to-button-flows/create-button-7.png)  
...
10. Seleccione el botón **Crear flujo** para guardar el flujo instantáneo: ![Botón de creación de flujo](./media/introduction-to-button-flows/create-button-10.png)  
11. En poco tiempo verá este mensaje de operación correcta:  
    ![Mensaje de proceso correcto](./media/introduction-to-button-flows/create-button-11.png)  
...
2. Puede pulsar cualquiera de estas opciones, en función de lo que le gustaría realizar:    
   ...
   ![Vista del historial de ejecución](./media/introduction-to-button-flows/manage-flow-4.png)  
